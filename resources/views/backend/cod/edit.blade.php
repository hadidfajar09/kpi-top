      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Data COD</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-danger">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('cod.updated',$cod->id) }}" class="form-profile" data-toggle="validator" method="post" enctype="multipart/form-data" >
              @csrf
              <div class="card-body">
                <div class="form-group row">
                  <label for="path_slider" class="col-md-4 col-md-offset-1 control-label">Foto lama</label>
                    <div class="col-md-8">
                        <img src="{{ asset($cod->path_foto) }}" width="450" alt="">
                  </div>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                          <textarea class="form-control" name="catatan" id="" cols="30" rows="5">{{ $cod->catatan }}</textarea>
