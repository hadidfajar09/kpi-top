      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-danger">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('absen.logout') }}" class="form-profile" data-toggle="validator" method="post" enctype="multipart/form-data" >
              @csrf
              <div class="card-body ">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                      ...
                      <input type="hidden" name="foto_pulang" class="image-tag">
                  </div>
                  </div>
