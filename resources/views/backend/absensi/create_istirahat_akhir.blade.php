      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Absen Akhir Istirahat</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title">Absen Akhir Istirahat</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('absen.rest.akhir') }}" class="form-profile" data-toggle="validator" method="post" enctype="multipart/form-data" >
              @csrf
              <div class="card-body ">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                      ...
                      <input type="hidden" name="foto_akhir" class="image-tag">
                  </div>
                  </div>
