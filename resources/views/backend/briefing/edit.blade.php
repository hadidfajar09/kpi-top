        ...
        <div class="col-md-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title">Data Briefing</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('briefing.updated',$briefing->id) }}" class="form-profile" data-toggle="validator" method="post" enctype="multipart/form-data" >
              @csrf
              <div class="card-body">
                    ...
                    <div class="col-md-8">
                      <select class="form-control" name="penempatan_id" id="penempatan_id" required>
                        ...
                        @foreach($penempatan as $row)
                          <option value="{{ $row->id }}" @if($briefing->penempatan_id == $row->id) selected @endif>{{ $row->nama }}</option>
                          @endforeach
                ...
                <div class="form-group row">
                  <label for="path_slider" class="col-md-4 col-md-offset-1 control-label">Foto lama</label>
                    <div class="col-md-8">
                        <img src="{{ asset($briefing->path_foto) }}" width="450" alt="">
                  </div>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                          <textarea class="form-control" name="catatan" id="" cols="30" rows="5">{{ $briefing->catatan }}</textarea>
                          <span class="help-block with-errors text-danger"></span>
